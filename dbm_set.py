...
connection = pyodbc.connect(
    "DRIVER={/Library/ODBC/FileMaker ODBC.bundle/Contents/MacOS/fmodbc.so};SERVER=localhost;DATABASE=Schulung;UID=python;PWD=python12")
...
cursor.execute(
    "update DBM set Termin=?,PME=?,PMA=?,PMG=?,Zeitfenster=? where SID='SID1'",
    (TSID1,
     TPE1,
     TPA1,
     TPG1,
     zr1))
cursor.execute(
    "update DBM set Termin=?,PME=?,PMA=?,PMG=?,Zeitfenster=? where SID='SID2'",
    (TSID2,
     TPE2,
     TPA2,
     TPG2,
     zr2))
cursor.execute(
    "update DBM set Termin=?,PME=?,PMA=?,PMG=?,Zeitfenster=? where SID='SID3'",
    (TSID3,
     TPE3,
     TPA3,
     TPG3,
     zr3))
cursor.execute(
    "update DBM set Termin=?,PME=?,PMA=?,PMG=?,Zeitfenster=? where SID='SID4'",
    (TSID4,
     TPE4,
     TPA4,
     TPG4,
     zr4))
cursor.execute(
    "update DBM set Termin=?,PME=?,PMA=?,PMG=?,Zeitfenster=? where SID='SID5'",
    (TSID5,
     TPE5,
     TPA5,
     TPG5,
     zr5))
cursor.execute(
    "update DBM set Termin=?,PME=?,PMA=?,PMG=?,Zeitfenster=? where SID='SID6'",
    (TSID6,
     TPE6,
     TPA6,
     TPG6,
     zr6))
cursor.execute(
    "update DBM set Termin=?,PME=?,PMA=?,PMG=?,Zeitfenster=? where SID='SID7'",
    (TSID7,
     TPE7,
     TPA7,
     TPG7,
     zr7))
cursor.execute(
    "update DBM set Termin=?,PME=?,PMA=?,PMG=?,Zeitfenster=? where SID='SID8'",
    (TSID8,
     TPE8,
     TPA8,
     TPG8,
     zr8))
cursor.execute(
    "update DBM set Termin=?,PME=?,PMA=?,PMG=?,Zeitfenster=? where SID='SID9'",
    (TSID9,
     TPE9,
     TPA9,
     TPG9,
     zr9))
cursor.execute(
    "update DBM set Termin=?,PME=?,PMA=?,PMG=?,Zeitfenster=? where SID='SID10'",
    (TSID10,
     TPE10,
     TPA10,
     TPG10,
